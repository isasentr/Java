...
public class _02_JavaMap {
    public static void main(String[] args) {
        ...
        nKartvizit.put("telefon","343535353");
        ...
        kKartvizit.put("telefon","999535353");

        Map<String,Map<String,String>>kartDefteri=new LinkedHashMap<>(); // Maplaerin Map i
        kartDefteri.put("nazmiye",nKartvizit); // nazmiye anahtarına Nazmiyenin Kartvizi atandı.
