...
public class _04_Ornek2 {
    public static void main(String[] args) {
        ...
        double boykiloendeks =kilo /(boy*boy);
        System.out.println("boykiloendeks = " + boykiloendeks);

        int boykiloendeks1 =(int)kilo /(boy*boy);
        System.out.println("boykiloendeks1 = " + boykiloendeks1);
